...
VectorXd Fx::fx()
{
    ...
    //(VV)
    BCtemp1(0) = Y49new(0) - (Vbz*cos(Y49new(6))*cos(Y49new(7)) + Vbx*sin(Y49new(7))*cos(Y49new(6)) - Vby*sin(Y49new(6)));
    BCtemp1(1) = Y49new(1) - (Vbx*cos(Y49new(7)) - Vbz*sin(Y49new(7)));
    BCtemp1(2) = Y49new(2) - (Vbz*cos(Y49new(7))*sin(Y49new(6)) + Vbx*sin(Y49new(6))*sin(Y49new(7)) + Vby*cos(Y49new(6)));
    BCtemp1(3) = Y49new(8);
    BCtemp1(4) = Y49new(9);
